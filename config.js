...
//  1. 도구 유닛 예외        조합 재료이지만 1회만 필요한 도구형 재료
//  2. 유닛별 특수 동작      자동 완료/콤보 슬롯/프리셋 중복 제한
//  3. 1개 제한 유닛         장바구니·프리셋에서 1개만 유지할 유닛
//  4. 특수 조건 문구        재료 조건·유닛 자체 조합 조건 안내 문구
//  5. 검색/선택 제한        숨김·직접 선택 제한·등급 예외 허용
//  6. 프리셋 버튼           일반/정수 프리셋 버튼 목록
//
