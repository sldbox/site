...
(() => {
    ...
    function startNexusApp(){
        try {
            ...
            initializeCacheEngine(); loadNexusState(); loadFontScale(); renderCostboardAtoms(); renderTabs(); selectTab(0); debouncedUpdateAllPanels(); setupSearchEngine(); setupInitialView(); renderPresetButtons();
            updateHideCompletedBtn();
            requestAnimationFrame(() => {
                debouncedUpdateAllPanels();
            });
